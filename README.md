...
Inspectable Actor I entirely created using blueprints It Derived from the baseInteractable Actor. I used the scene capture 2d component with render target to show inspectable actor in UI canvas. 
...
2. I would like to add more interation types in this like SPAM Interact. you have to spam a interact
button for a while to interact. 

3. I would like to use Strategy pattern for interaction system. 
It follows Open/Closed Principle. You can add new interactions without modifying existing code.
Like you can create diff strategies example . Pickup strategy and you can reuse it.